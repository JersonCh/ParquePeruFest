...
class _ComprarEntradasPageState extends State<ComprarEntradasPage> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildOpcionTicket(
                            ...
                            descripcion:
                                'Acceso completo al parque y actividades',
                          ),
                          ...
                          // Resumen
                          if (_tipoSeleccionado != null) _buildResumen(),
  ...
  Widget _buildResumen() {
    ...
    if (_tipoSeleccionado == TipoEntrada.entrada) {
      precioUnitario =
          PreciosConfig.calcularPrecioEntrada(
  ...
  void _actualizarTotal() {
    _cantidadPersonas =
        _cantidadAdultos + _cantidadNinos + _cantidadAdultosMayor;
  ...
  void _continuarCompra() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) => FormularioCompraPage(
              tipoEntrada: _tipoSeleccionado!,
              cantidadPersonas:
                  (_tipoSeleccionado == TipoEntrada.cochera)
                      ? 1
                      : _cantidadPersonas,
